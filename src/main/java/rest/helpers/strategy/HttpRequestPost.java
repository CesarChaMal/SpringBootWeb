...
public class HttpRequestPost implements HttpRequestCallback, HttpRequestMethod {
	...
	public HttpRequestPost(String url, String data)
	{
...
//		this.makeRequest(urlPath, json, this);	
	...
	{
		HttpRequestUtilPost request = new HttpRequestUtilPost();
		request.makeRequest(urlpath, data, HttpRequestType.POST, httpRequestCallback);
