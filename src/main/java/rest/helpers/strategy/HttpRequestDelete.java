...
public class HttpRequestDelete implements HttpRequestCallback, HttpRequestMethod {
	...
	public HttpRequestDelete(String url, String data)
	{
...
//		this.makeRequest(urlPath, json, this);	
	...
	{
		HttpRequestUtilDelete request = new HttpRequestUtilDelete();
		request.makeRequest(urlpath, querystring, HttpRequestType.DELETE, httpRequestCallback);
