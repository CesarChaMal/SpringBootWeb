...
public class HttpRequestPut implements HttpRequestCallback, HttpRequestMethod {
	...
	public HttpRequestPut(String url, String data)
	{
...
//		this.makeRequest(urlPath, json, this);	
	...
	{
		HttpRequestUtilPut request = new HttpRequestUtilPut();
		request.makeRequest(urlpath, data, HttpRequestType.PUT, httpRequestCallback);
